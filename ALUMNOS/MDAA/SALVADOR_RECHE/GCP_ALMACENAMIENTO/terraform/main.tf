...
resource "google_compute_instance_from_machine_image" "delivery_app" {
  ...
  zone           = var.zone
  source_machine_image  = "projects/${var.project_id}/global/machineImages/maquina"
...
resource "google_storage_bucket" "data_lake" {
  name          = "datalake-salvilla-edem-2026"  # Poner aquí el MISMO nombre que creaste a mano
  location      = var.region
  force_destroy = true
