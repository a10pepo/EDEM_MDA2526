# Ejercicios entregables - Python - CELIA SARRIÓ COLOMAR 
...
# 2. Crea una condición en la que sí festivo es verdadero se muestre por consola “Hoy es fiesta voy a echarme una siesta!!” y sino que muestre por consola 
...
## Comprobar si funciona la función:

print(ultimoCaracter("Celia"))
