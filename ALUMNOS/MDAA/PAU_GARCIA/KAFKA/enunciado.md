...
- Un producer diagnosticador que produce encargos de reparación y avisa a administración de que la reparación no es posible.
...
- Un topic "encargos_coches" con un filtro de ksql que envie al topic "encargos_finalizados" en caso de no poder arreglarlo. Produce el diagnosticador y consume el taller
