...
import random
import time
import os  # <--- IMPORTANTE: Necesario para configurar el proyecto
...
if __name__ == "__main__":
    ...
    # Esto fuerza al código a buscar la suscripción en tu proyecto correcto
    os.environ["GOOGLE_CLOUD_PROJECT"] = "e2e-gemma-balaguer"
    # ----------------------------------
