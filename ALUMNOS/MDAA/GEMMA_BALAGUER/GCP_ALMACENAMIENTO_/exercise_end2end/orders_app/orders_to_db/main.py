...
# ### <--- NUEVO: Enviar evento de pago
        # Simulamos que el pago siempre es exitoso (CONFIRMED)
        payment_message = {
        ...
        payment_producer.send_message(payment_message)
        logging.info(f"Payment event sent for Order {order_id}")
