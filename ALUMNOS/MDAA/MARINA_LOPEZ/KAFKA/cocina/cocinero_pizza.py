...
conf = {
    ...
    'group.id': 'equipo_pizza',
    'auto.offset.reset': 'latest'
}
consumer = Consumer(conf)
consumer.subscribe(['pedidos_pizza'])

print(f"{Fore.GREEN}🍕 COCINERO PIZZA: Listo y esperando tickets...")
...
try:
    ...
    print((f"{Fore.RED}Horno apagado por el usuario."))
finally:
    consumer.close()
