...
cp /etc/host /tmp/PRUEBA/
# se utiliza host pq mtab no existe en MacOS

# 19.Copiar /etc/mtab en dir1, dir2 y dir3.
cp /etc/host /tmp/PRUEBA/dir1/
cp /etc/host /tmp/PRUEBA/dir2/
cp /etc/host /tmp/PRUEBA/dir3/

cp/etc/host /tmp/PRUEBA/dir{1,2,3}/
