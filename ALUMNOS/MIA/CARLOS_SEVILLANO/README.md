# ¡Hola! Soy Carlos Sevillano Torres 👋

Bienvenido a mi perfil de GitHub. Soy un apasionado de **la tecnología**, **la IA**, **las matemáticas** y todo lo relacionado con la **nube**. Actualmente estoy estudiando un **Máster en Inteligencia Artificial** en **EDEM**, donde profundizo en cómo las tecnologías emergentes pueden transformar el mundo.
...
- **📊 Análisis de Big Data para optimización de procesos**: [Enlace al proyecto]()
- **☁️ Implementación de soluciones en la nube**: [Enlace al proyecto]()
...
- **LinkedIn**: [Carlos]()
- **Correo electrónico**: sevillanotorrescarlos.jm@gmail.com
...
## 🎯 Objetivos
En el futuro, quiero seguir desarrollándome como **experto en Inteligencia Artificial**, colaborar en proyectos innovadores y contribuir al avance de la tecnología en el ámbito empresarial.
